...
public class SaveStudent extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        new Activities<Student>().registerStudent(new Student(
                new Department(1), 
                request.getParameter("firstname"), 
                request.getParameter("othername"), 
                new Date(), 
                Academic_Program.valueOf(request.getParameter("academic")), 
                Health_Status.valueOf(request.getParameter("health")), 
                Payment_Mode.valueOf(request.getParameter("payment")), 
